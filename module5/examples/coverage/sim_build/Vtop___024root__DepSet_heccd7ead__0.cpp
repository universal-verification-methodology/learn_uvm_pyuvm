...
#endif
            VL_FATAL_MT("../../dut/advanced/multi_channel.v", 17, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../../dut/advanced/multi_channel.v", 17, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../../dut/advanced/multi_channel.v", 17, "", "Active region did not converge.");
            }
...
void Vtop___024root___eval_debug_assertions(Vtop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.master_valid & 0xfeU)))) {
        Verilated::overWidthError("master_valid");}
    if (VL_UNLIKELY(((vlSelfRef.slave_valid & 0xfeU)))) {
        Verilated::overWidthError("slave_valid");}
}
#endif  // VL_DEBUG
