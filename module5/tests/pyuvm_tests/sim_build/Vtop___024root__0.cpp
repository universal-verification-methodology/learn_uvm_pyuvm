...
void Vtop___024root___eval_ico(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VicoTriggered[0U])) {
        vlSelfRef.multi_channel__DOT__clk = vlSelfRef.clk;
        vlSelfRef.multi_channel__DOT__rst_n = vlSelfRef.rst_n;
        vlSelfRef.multi_channel__DOT__master_valid 
            = vlSelfRef.master_valid;
        vlSelfRef.master_ready = vlSelfRef.multi_channel__DOT__master_ready;
        vlSelfRef.multi_channel__DOT__master_data = vlSelfRef.master_data;
        vlSelfRef.multi_channel__DOT__slave_valid = vlSelfRef.slave_valid;
        vlSelfRef.slave_ready = vlSelfRef.multi_channel__DOT__slave_ready;
...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered[0U] = (QData)((IData)(
                                                    ((((~ (IData)(vlSelfRef.multi_channel__DOT__rst_n)) 
                                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__multi_channel__DOT__rst_n__0)) 
                                                      << 1U) 
                                                     | ((IData)(vlSelfRef.multi_channel__DOT__clk) 
...
void Vtop___024root___eval_nba(Vtop___024root* vlSelf) {
    ...
    if ((3ULL & vlSelfRef.__VnbaTriggered[0U])) {
        vlSelfRef.multi_channel__DOT__master_ready 
            = ((IData)(vlSelfRef.multi_channel__DOT__rst_n) 
               && (IData)(vlSelfRef.multi_channel__DOT__master_valid));
        vlSelfRef.multi_channel__DOT__slave_ready = 
            ((IData)(vlSelfRef.multi_channel__DOT__rst_n) 
             && (IData)(vlSelfRef.multi_channel__DOT__slave_valid));
        vlSelfRef.master_ready = vlSelfRef.multi_channel__DOT__master_ready;
        vlSelfRef.slave_ready = vlSelfRef.multi_channel__DOT__slave_ready;
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("../../dut/advanced/multi_channel.v", 17, "", "Input combinational region did not converge after 100 tries");
        }
    ...
    do {
...
#endif
            VL_FATAL_MT("../../dut/advanced/multi_channel.v", 17, "", "NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("../../dut/advanced/multi_channel.v", 17, "", "Active region did not converge after 100 tries");
            }
