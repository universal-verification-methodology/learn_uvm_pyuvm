...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("../../dut/dma/simple_dma.v", 18, "", "Input combinational region did not converge after 100 tries");
        }
    ...
    do {
...
#endif
            VL_FATAL_MT("../../dut/dma/simple_dma.v", 18, "", "NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("../../dut/dma/simple_dma.v", 18, "", "Active region did not converge after 100 tries");
            }
